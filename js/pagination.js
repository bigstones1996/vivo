...
Pagination.prototype.dongcidaci = function () {
    ...
    this.ele.onclick = (e) => {
        ...
        //点击go按钮
        if (target.innerHTML == "确定" && this.default.pageInfo.pagenum != target.previousElementSibling.value &target.previousElementSibling.value>0) {
            //修改页码
            if (target.previousElementSibling.value<=this.default.pageInfo.totalpage) {
